...
def update_arrow():
    global arrow_actor, target_actor, lat2, lon2
    ...
    move_angle = velocity * DT / RADIUS  # angular distance to move along sphere
